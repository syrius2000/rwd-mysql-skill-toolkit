...
使い方（プロジェクトルートで実行）:
  python3 -m flat_file_mysql.cli step1 file1.csv file2.csv -o ./skill-output/step1_sample_sql
  python3 -m flat_file_mysql.cli step3 complete.sql -d mydb --table mytbl --expected-count 100
  python3 -m flat_file_mysql.cli pipeline file.csv -o ./skill-output/step1_sample_sql
"""
