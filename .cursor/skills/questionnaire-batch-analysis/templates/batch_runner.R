...
summary_columns <- c(
  ...
  "statistic_value","df","p_value","effect_name","effect_value",
...
for (i in seq_len(nrow(cfg))) {
  ...
  rows[[i]] <- data.frame(
    ...
    cramer_v_marginal    = m$cramer_v_marginal,
    cramer_v_df_star     = m$cramer_v_df_star,
    cramer_v_effect_label = m$cramer_v_effect_label,
    cramer_v_strata_json = m$cramer_v_strata_json,
    cramer_v_strata_mean = m$cramer_v_strata_mean,
    cramer_v_strata_max  = m$cramer_v_strata_max,
    cramer_v_strata_max_level = m$cramer_v_strata_max_level,
    marginal_strata_signal = m$marginal_strata_signal,
    marginal_strata_note = m$marginal_strata_note,
